...
import { User, Building, Users, AlertCircle, UserPlus, Brain, Layers, Building2, Factory, Landmark, CreditCard, Smartphone, ShieldCheck } from 'lucide-react';
  ...
  const plansData = {
    individual: {
      ...
      expert: {
        ...
        popular: true,
        features: [
          { text: 'Acceso a IA, IMCYC (incl. 750 mil créditos)', included: true },
    ...
    membresias: {
      agregados: {
        ...
        features: [
          ...
          { text: 'Acceso a IA, IMCYC (incl. 2.25 millones de créditos)', included: true },
      ...
      concreto: {
        ...
        features: [
          ...
          { text: 'Logotipo en página web', included: true },
          { text: 'Acceso a IA, IMCYC (incl. 4 millones de créditos)', included: true },
      ...
      cemento: {
        ...
        features: [
          ...
          { text: 'Logotipo en página web', included: true },
          { text: 'Acceso a IA, IMCYC (incl. 8 millones de créditos)', included: true },
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-16">
          {Object.values(currentPlans).map((plan, index) => (
            <PricingCard
              ...
              onSubscribe={selectedType === 'individual' ? (details) => {
                setSelectedPlan({
                  ...details,
                  planKey: details.planKey || planNameToSlug(details.name),
                });
